...
- [x] Title/author extraction (title-page "by" pattern -> metadata; never filename)
...
- Paragraph merging uses three layers: within-page (indentation+gap), cross-page (sentence-ender), HTML post-processing (mid-sentence merge across image/footnote blocks)
